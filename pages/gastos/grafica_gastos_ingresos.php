...
       </div>
                        ...
                        <div class="box-body">
                                    <a class = "btn btn-success btn-print" href = "buscar_gastos_ingresos.php" ><i class ="glyphicon glyphicon-print"></i> Volver</a>
                                                                        <a class = "btn btn-success btn-print" href = "buscar_gastos_ingresos.php"   onclick = "window.print()"><i class ="glyphicon glyphicon-print"></i> Imprimir</a>
  ...
  $fecha_inicio=$year."-".$mes."-01";
    $fecha_fin=$year."-".$mes."-31";

?>
  <?php

      $query=mysqli_query($con,"select * from gastos   where fecha >='$fecha_inicio' and fecha <='$fecha_fin' ")or die(mysqli_error());
...
$cantidad_ingresos=$cantidad_enero_total+$cantidad_febrero_total+$cantidad_marzo_total+$cantidad_abril_total+$cantidad_mayo_total+$cantidad_junio_total+$cantidad_julio_total+$cantidad_agosto_total+$cantidad_setiembre_total+$cantidad_octubre_total+$cantidad_noviembre_total+$cantidad_diciembre_total;
