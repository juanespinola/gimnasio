...
INSERT INTO caja VALUES("1","cerrado","687","2020-03-08","2020-06-24"),
("2","abierto","10","2020-06-24","0000-00-00");
...
INSERT INTO clientes VALUES("1","pedro suarez","12312321","435435353","54344556","1990-03-16");
...
INSERT INTO detalles_pedido VALUES("1","1","5","1","1","2020-06-23"),
...
INSERT INTO empresa VALUES("1","gimnacio tusolutionweb","354355","av san jeroronimo","935142132","rubro de ventas","logo.jpg","tusolutionweb@gmail.com","2","Nuevo sol","S/.","1","5","2");
...
INSERT INTO gastos VALUES("1","2020-03-09","13123","13"),
...
("229","5","se ha desconectado el sistema en ","2020-06-25 04:13:35"),
("230","5","se ha desconectado el sistema en ","2020-06-25 04:13:43"),
("231","5","se ha desconectado el sistema en ","2020-06-25 04:17:22");



DROP TABLE IF EXISTS pagar_credito;

CREATE TABLE `pagar_credito` (
  `id_pagar_credito` int(200) NOT NULL AUTO_INCREMENT,
  `codigo` int(200) NOT NULL,
  `fecha` date NOT NULL,
  `monto` float NOT NULL,
  PRIMARY KEY (`id_pagar_credito`)
...
INSERT INTO pedidos VALUES("1","2020-06-23","5","1","330"),
("2","2020-06-24","5","1","0"),
("3","2020-06-24","5","1","0");



DROP TABLE IF EXISTS plan_asistencia;

CREATE TABLE `plan_asistencia` (
  `id_plan_asistencia` int(200) NOT NULL AUTO_INCREMENT,
  `fecha_asistencia` date NOT NULL,
  `plan_cliente` int(200) NOT NULL,
  PRIMARY KEY (`id_plan_asistencia`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

INSERT INTO plan_asistencia VALUES("1","2020-06-24","4");
...
CREATE TABLE `plan_cliente` (
  `id_plan_cliente` int(200) NOT NULL AUTO_INCREMENT,
...
INSERT INTO plan_cliente VALUES("1","202003151","2019-09-15","2019-10-15","1","1","0","30"),
...
CREATE TABLE `planes` (
  `id_plan` int(200) NOT NULL AUTO_INCREMENT,
...
INSERT INTO planes VALUES("1","full 30","dias","30","fuck","150"),
...
INSERT INTO sueldo_empleado VALUES("1","6","1000");
...
INSERT INTO sueldo_pago VALUES("1","2020-06-24","1000","6");
...
INSERT INTO usuario VALUES("5","admin","a1Bz20ydqelm8m1wql21232f297a57a5a743894a0e4a801fc3","58384352_2392346464143161_9100511151573172224_n.jpg","administrador","Roy","Mustang","","tusolutionweb@gmail.com",""),
...
CREATE TABLE `venta_diaria` (
  `id_venta_diaria` int(200) NOT NULL AUTO_INCREMENT,
  `codigo` varchar(200) NOT NULL,
  `fecha` date NOT NULL,
  `id_cliente` int(200) NOT NULL,
...
INSERT INTO venta_diaria VALUES("1","202003101","2020-03-10","1"),
