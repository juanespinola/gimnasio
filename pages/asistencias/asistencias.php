    ...
    <div class="container body">
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                ...
                <div class="box-body">
                    <div class="box-header">
                        <h3 class="box-title">Actividades / Asistencias</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success btn-print" title="Marcar Asistencia" href="<?php echo "./insert_asistencia.php?id_actividad=$id_actividad"; ?>" onClick="return confirm('¿Está seguro de que quieres confirmar asistencia?');">Marcar Asistencia</a>
                                            <a class="btn btn-danger btn-print" title="Detalles Asistencias" href="<?php echo "./detalle_asistencia.php?id_actividad=$id_actividad"; ?>">Detalles Asistencia</a>
                                        </td>
                                    </tr>
