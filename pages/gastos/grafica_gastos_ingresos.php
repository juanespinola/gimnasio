    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
        ...
        <div class="box-body">
          ...
          $query = mysqli_query($con, "select * from gastos where fecha >='$fecha_inicio' and fecha <='$fecha_fin' ") or die(mysqli_error($con));
      ...
      ON c.id_cliente = z.id_cliente   where fecha_inicio >='$noviembre_inicio' and fecha_inicio <='$noviembre_fin'") or die(mysqli_error($con));
          while ($row = mysqli_fetch_array($query)) {
      ...
      ON c.id_producto = z.id_producto   where p.fecha >='$agosto_inicio' and p.fecha <='$agosto_fin'") or die(mysqli_error($con));
          while ($row = mysqli_fetch_array($query)) {
            $cantidad_agosto = $row['precio_venta'] * $row['cantidad'] + $cantidad_agosto;
          }
          $query = mysqli_query($con, "select * from pedidos AS p INNER JOIN detalles_pedido AS z
      ON p.id_pedido = z.id_pedido INNER JOIN producto AS c
      ON c.id_producto = z.id_producto   where p.fecha >='$setiembre_inicio' and p.fecha <='$setiembre_fin'") or die(mysqli_error($con));
          while ($row = mysqli_fetch_array($query)) {
          ...
          $query = mysqli_query($con, "select * from pedidos AS p INNER JOIN detalles_pedido AS z
      ON p.id_pedido = z.id_pedido INNER JOIN producto AS c
      ON c.id_producto = z.id_producto    where p.fecha >='$octubre_inicio' and p.fecha <='$octubre_fin'") or die(mysqli_error($con));
          while ($row = mysqli_fetch_array($query)) {
          ...
          $query = mysqli_query($con, "select * from pedidos AS p INNER JOIN detalles_pedido AS z
      ON p.id_pedido = z.id_pedido INNER JOIN producto AS c
      ON c.id_producto = z.id_producto   where p.fecha >='$noviembre_inicio' and p.fecha <='$noviembre_fin'") or die(mysqli_error($con));
          while ($row = mysqli_fetch_array($query)) {
          ...
          $query = mysqli_query($con, "select * from pedidos AS p INNER JOIN detalles_pedido AS z
      ON p.id_pedido = z.id_pedido INNER JOIN producto AS c
      ON c.id_producto = z.id_producto    where p.fecha >='$diciembre_inicio' and p.fecha <='$diciembre_fin'") or die(mysqli_error($con));
          while ($row = mysqli_fetch_array($query)) {
