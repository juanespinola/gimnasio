...
<head>
  ...
  <style type="text/css">
    #myInput {
      background-image: url('../ventas_membrecia/css/buscador.png');
            ...
            <div class="box-body">
              <div class="box">
                ...
                <div class="box-body no-padding">
                  ...
                  <form class="form-inline" name="f1" action="../ventas_menbrecia/terminarVenta.php" method="POST">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4 btn-print">
                        <div class="form-group">
                          <select class="form-control select2" name="id_plan" required>

                            <?php

                            $queryc = mysqli_query($con, "select * from planes") or die(mysqli_error($con));
                            while ($rowc = mysqli_fetch_array($queryc)) {
                            ?>
                              <option value="<?php echo $rowc['id_plan']; ?>"><?php echo $rowc['nombre_plan'] . ' - ' . $rowc['numero_tiempo'] . '  ' . $rowc['tipo_tiempo'] . ' -precio= ' . $rowc['precio']; ?></option>
                            <?php } ?>
                          </select>
                        </div>
                      </div>
