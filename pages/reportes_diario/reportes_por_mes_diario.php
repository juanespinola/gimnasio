          ...
          <div class="box-body">
            <table id="example2" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                ?>
                  <?php
                  $query = mysqli_query($con, "select * from  venta_diaria AS z INNER JOIN clientes AS c ON c.id_cliente = z.id_cliente  where  MONTH(fecha)='$mes'  ") or die(mysqli_error($con));
                  $contador = 0;
