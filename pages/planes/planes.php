              ...
              <div class="row">
                <div class="col-md-3 btn-print">
                  <div class="form-group">
                    <label for="date">Nombre del Plan</label>
                        ...
                        <div class="modal-body" style="width: 100%; height: 100%;">
                          <form class="form-horizontal" method="post" action="plan_actualizar.php" enctype='multipart/form-data'>
                            ...
                            <div class="col-md-12 btn-print">
                              <div class="form-group">
                                <label class="control-label col-lg-3" for="nombre_plan">Nombre del Plan</label>
                                <div class="input-group col-md-8">
                                  <input type="text" class="form-control" id="nombre_plan" name="nombre_plan" value="<?php echo $row['nombre_plan']; ?>" required>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="col-md-12 btn-print">
                              <div class="form-group">
                                <label class="control-label col-lg-3" for="tipo_tiempo">Tipo tiempo</label>
                                <div class="input-group col-md-8">
                                  <select class="form-control select2" style="width: 60%;" name="tipo_tiempo" id="tipo_tiempo">
                                    <option value="dias" <?php if ($tipo_tiempo == "dias") {
                                                            echo "selected";
                                                          } ?>>Dias</option>
                            ...
                            <div class="col-md-12 btn-print">
                              ...
                              <div class="form-group">
                                <label class="control-label col-lg-3" for="numero_tiempo">Numero de dias/meses</label>
                                <div class="input-group col-md-8">
