          ...
          <div class="box-body">
            <table id="example2" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                ?>
                  <?php
                  $query = mysqli_query($con, "select * from planes AS p INNER JOIN plan_cliente AS z ON p.id_plan = z.id_plan INNER JOIN clientes AS c ON c.id_cliente = z.id_cliente   where  fecha_inicio >='$fecha_inicio' and fecha_inicio <='$fecha_final'  ") or die(mysqli_error($con));
                  $contador = 0;
