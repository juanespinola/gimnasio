 ...
 * //todo: cuando marcas asistencia debe poder hacer apretar el enter
 * //todo: Me permitió marcar la asistencia de un cliente (horario de 18-19 brazilian jiu jitsu 2 qué se hace los días lunes, miércoles, viernes) pero pude marcar un día miércoles a las 15:22… válida solo si es pasada la hora de la clase pero no si es antes de la clase?
 * //todo: punto de arriba, no hace el insert pero se ve que deja pasar
 * //todo: al marcar asistencia desde el modulo asistencia, permite cualquier horario y cualquier dia
 * // todo: Si un recordatorio estado finalizado inhabilitar boton accion finalizar 
