...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-06-2020 a las 03:14:28
...
(1, 'abierto', '687', '2020-03-08', '0000-00-00');
...
INSERT INTO `clientes` (`id_cliente`, `nombre`, `ruc`, `telefono`, `dni`, `fecha_cumple`) VALUES
(1, 'pedro suarez', '12312321', '435435353', '54344556', '1990-03-16');
...
INSERT INTO `detalles_pedido` (`id_detalles`, `id_pedido`, `id_producto`, `cantidad`, `id_cliente`, `fecha`) VALUES
(1, '1', 5, '1', 1, '2020-06-23'),
(2, '1', 6, '2', 1, '2020-06-23');
...
INSERT INTO `gastos` (`id_gastos`, `fecha`, `descripcion`, `cantidad`) VALUES
(1, '2020-03-09', '13123', '13'),
(2, '2020-06-26', 'asdad', '188');
...
(208, 5, 'se ha desconectado el sistema en ', '2020-03-03 00:10:07'),
(209, 5, 'se ha desconectado el sistema en ', '2020-03-04 11:28:02'),
(210, 6, 'se ha desconectado el sistema en ', '2020-03-04 11:28:37'),
(211, 5, 'se ha desconectado el sistema en ', '2020-03-04 19:08:35'),
(212, 5, 'se ha desconectado el sistema en ', '2020-03-06 21:50:58'),
(213, 5, 'se ha desconectado el sistema en ', '2020-03-07 08:57:58'),
(214, 5, 'se ha desconectado el sistema en ', '2020-03-07 22:26:03'),
(215, 5, 'se ha desconectado el sistema en ', '2020-03-08 09:30:09'),
(216, 5, 'se ha desconectado el sistema en ', '2020-03-09 22:24:00'),
(217, 5, 'se ha desconectado el sistema en ', '2020-03-10 13:21:26'),
(218, 5, 'se ha desconectado el sistema en ', '2020-03-10 13:28:35'),
(219, 5, 'se ha desconectado el sistema en ', '2020-03-12 11:35:39'),
(220, 5, 'se ha desconectado el sistema en ', '2020-03-15 11:01:06'),
(221, 5, 'se ha desconectado el sistema en ', '2020-03-15 11:06:57'),
(222, 5, 'se ha desconectado el sistema en ', '2020-03-15 11:25:33'),
(223, 5, 'se ha desconectado el sistema en ', '2020-06-02 17:24:28'),
(224, 5, 'se ha desconectado el sistema en ', '2020-06-19 08:38:10'),
(225, 0, 'se ha desconectado el sistema en ', '2020-06-23 04:55:43'),
(226, 5, 'se ha desconectado el sistema en ', '2020-06-24 03:23:55'),
(227, 5, 'se ha desconectado el sistema en ', '2020-06-24 13:49:19'),
(228, 5, 'se ha desconectado el sistema en ', '2020-06-24 13:49:51');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pagar_credito`
--

CREATE TABLE `pagar_credito` (
  `id_pagar_credito` int(200) NOT NULL,
...
INSERT INTO `pedidos` (`id_pedido`, `fecha`, `id_sesion`, `id_cliente`, `monto_pagado`) VALUES
(1, '2020-06-23', 5, 1, 330),
(2, '2020-06-24', 5, 1, 0),
(3, '2020-06-24', 5, 1, 0);
...
(1, 'full 30', 'dias', '30', 'fuck', '150'),
(2, '15 dias', 'dias', '15', 'plan 15', '30');
...
CREATE TABLE `plan_cliente` (
  ...
  `numero_dias_meses` int(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `plan_cliente` (`id_plan_cliente`, `codigo`, `fecha_inicio`, `fecha_fin`, `id_cliente`, `id_plan`, `pagado`, `numero_dias_meses`) VALUES
(1, '202003151', '2019-09-15', '2019-10-15', 1, 1, 0, 30),
(2, '202003152', '2020-03-15', '2020-04-14', 1, 1, 0, 0),
(3, '202006243', '2020-06-25', '2020-07-10', 1, 2, 30, 0),
(4, '202006244', '2020-06-17', '2020-07-17', 1, 1, 150, 1);
...
(1, 'Aceitilina', 'adsasd', 'filtro', 40, 30, 'bug bony no.jpg', '6', 'd'),
(2, 'CELULAR SAMSUNG J7 duo', 'celular ', 'celular', 700, 0, '', '10', 'd'),
(3, 'SDFS', 'SFDSF', 'SDFS', 7, 0, '', '20', 'd'),
(4, 'dgdfgdfgd', '', 'fsd', 1, 32, '', '3', 'd'),
(5, 'GEL PARA CANELLO', 'SFDSF', 'GEL', 30, 20, 'VENTAS.webp', '3', 'a'),
(6, 'ricocan', 'croquetas para perros', 'kilos', 150, 100, '', '90', 'a');
...
--
-- Volcado de datos para la tabla `sueldo_empleado`
--

INSERT INTO `sueldo_empleado` (`id_sueldo_empleado`, `idusuario`, `sueldo`) VALUES
(1, 6, 1000);
...
--
-- Volcado de datos para la tabla `sueldo_pago`
--

INSERT INTO `sueldo_pago` (`id_sueldo_pago`, `fecha_pago`, `pago`, `idusuario`) VALUES
(1, '2020-06-24', 1000, 6);
...
(6, 'empleado', 'a1Bz20ydqelm8m1wql21232f297a57a5a743894a0e4a801fc3', '', 'empleado', 'fredy', 'mercury', '345543', 'mercury@gmail.com', 'si');
...
--
-- Volcado de datos para la tabla `venta_diaria`
--

INSERT INTO `venta_diaria` (`id_venta_diaria`, `codigo`, `fecha`, `id_cliente`) VALUES
(1, '202003101', '2020-03-10', 1),
(2, '202003152', '2020-03-01', 1),
(3, '202006243', '0000-00-00', 0),
(4, '202006244', '2020-06-24', 1);
...
--
-- Indices de la tabla `pagar_credito`
--
ALTER TABLE `pagar_credito`
  ADD PRIMARY KEY (`id_pagar_credito`);
...
--
ALTER TABLE `gastos`
  MODIFY `id_gastos` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
-- AUTO_INCREMENT de la tabla `pagar_credito`
--
ALTER TABLE `pagar_credito`
  MODIFY `id_pagar_credito` int(200) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `planes`
  MODIFY `id_plan` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `plan_cliente`
  MODIFY `id_plan_cliente` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `producto`
--
ALTER TABLE `producto`
  MODIFY `id_pro` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT de la tabla `sueldo_empleado`
--
ALTER TABLE `sueldo_empleado`
  MODIFY `id_sueldo_empleado` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `sueldo_pago`
--
ALTER TABLE `sueldo_pago`
  MODIFY `id_sueldo_pago` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `venta_diaria`
  MODIFY `id_venta_diaria` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
