...
<body>
  ...
  $query3 = mysqli_query($con, "SELECT * 
    FROM clientes c 
    INNER JOIN ventas v ON c.id_cliente = v.id_cliente where v.id_venta='$num_pedido' ") or die(mysqli_error($con));
  ...
  $query5 = mysqli_query($con, "SELECT * 
    ...
    WHERE id_venta='$num_pedido' ") or die(mysqli_error($con));
  ...
  <div id="page-wrap">
    ...
    background-color: #1883ba;
    border-radius: 6px;
    border: 2px solid #0016b0; " href="../ventas/ventas_productos_totales.php"><i class="glyphicon glyphicon-print"></i>Regresar</a>
      ...
      <table class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          FROM producto p 
          INNER JOIN ventas_detalle vd ON p.id_producto = vd.id_producto  
          WHERE id_venta='$num_pedido'") or die(mysqli_error($con));
          ...
          ?>
            <tr style="border:none;  ">
              ...
              <td style="border:none;">
              <td style="width: 300px;"><?php echo $row4['nombre_producto']; ?></td>
