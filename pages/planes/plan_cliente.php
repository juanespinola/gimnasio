  ...
  <div class="container body">
    <div class="main_container">
      ...
      <div class="right_col" role="main">
        ...
        <form class="form-horizontal" method="post" action="plan_cliente_add.php" enctype='multipart/form-data'>
          ...
          <div class="row">
            <div class="col-md-3 btn-print">
              <div class="form-group">
                <label for="date">Tipo pago</label>

              </div><!-- /.form group -->
            </div>
            <div class="col-md-4 btn-print">
              <div class="form-group">
                <select class="form-control select2" name="tipo_pago" required>
          ...
          <div class="row">
            <div class="col-md-3 btn-print">
              <div class="form-group">
                <label for="date">Actual/antiguo</label>

              </div><!-- /.form group -->
            </div>
            <div class="col-md-4 btn-print">
              <div class="form-group">
                <select class="form-control select2" name="actual_antiguo" required>
