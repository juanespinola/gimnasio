                    ...
                    <div class="box-body">
                        <table id="example2" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                WHERE a.id_sucursal = '$id_sucursal' AND cu.fecha_pago IS NULL
                                GROUP BY a.id_actividad, cliente, profesor, horario, deporte, dias, pl.id_plan, pl.nombre_plan, cu.fecha_fin") or die(mysqli_error($con));
                                $i = 0;
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger btn-print" title="Detalle Cuota" href="<?php echo "detalle_cuota.php?id_actividad=$id_actividad"; ?>">Detalle</a>
                                            <a class="btn btn-success btn-print" title="Cobrar Cuota" href="<?php echo "agregar_pago_cuota.php?id_actividad=$id_actividad"; ?>">Pago Cuota</a>
                                        </td>
                                    </tr>
