                        ...
                        <table id="example2" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:10%"> Pago por clase</th>
                            ...
                            <tbody>
                                ...
                                JOIN clientes c ON a.id_cliente = c.id_cliente") or die(mysqli_error($con));
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <!-- <td><a class="btn btn-primary btn-print" href="<?php echo "pagar_sueldo.php?id_sueldo_profesor=$id_sueldo_profesor"; ?>" role="button">Pagar Sueldo</a></td> -->
                                        <!-- <td><a class="btn btn-warning btn-print" href="<?php echo "pagos_hechos.php?id_sueldo_profesor=$id_sueldo_profesor"; ?>" role="button">Pagos hechos</a></td> -->
                                        ...
                                        <td><a class="btn btn-danger btn-print" title="Editar Sueldo" href="<?php echo "editar_salario_profesor.php?id_sueldo_profesor=$id_sueldo_profesor"; ?>">Editar</a></td>
                                    </tr>
