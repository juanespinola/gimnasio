  ...
  <div class="container body">
    <div class="main_container">
      ...
      <div class="right_col" role="main">
        ...
        $numero_dias_meses = 0;
        $numero_tiempo = 0;
        $query2 = mysqli_query($con, "select * from plan_cliente where id_plan_cliente='$id_plan_cliente' ") or die(mysqli_error());

        while ($row2 = mysqli_fetch_array($query2)) {
          $numero_dias_meses = $row2['numero_dias_meses'];
          $id_plan = $row2['id_plan'];
        }
        $tipo_tiempo = "";

        $query2 = mysqli_query($con, "select * from planes where id_plan='$id_plan' ") or die(mysqli_error());
        ...
        $query2 = mysqli_query($con, "select * from plan_asistencia where plan_cliente='$id_plan_cliente' ") or die(mysqli_error());
        ...
        <div class="box-body">
          ...
          <?php
          //echo $numero_dias_meses.'  '.$numero_tiempo;
          if ($contador_asistencias < $numero_tiempo) {
            # code...
