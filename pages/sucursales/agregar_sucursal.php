    ...
    <div class="container body">
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                ...
                <div class="box-body">
                    <form class="form-horizontal" method="post" action="insert_sucursal.php" enctype='multipart/form-data'>
                        <!-- CAMPO ALUMNO -->
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 btn-print">
                                <div class="form-group">
                                    <input type="text" class="form-control pull-right" id="direccion" name="direccion" placeholder="Direccion" required>
